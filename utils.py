...
class TestSetLoader(Dataset):
    ...
    def __getitem__(self, index):
        ...
        lr_image_left = Image.open(self.dataset_dir + '/lr_x' + str(self.scale) + '/' + self.file_list[index] + '/lr0.png')
        lr_image_right = Image.open(self.dataset_dir + '/lr_x' + str(self.scale) + '/' + self.file_list[index] + '/lr1.png')
